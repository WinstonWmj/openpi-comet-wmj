...
exp_name=pi05_b1k-turning_on_radio-rft_pt50_step50k-checkpoints_official_task00
...
CMD="python scripts/train.py ${config_name} --exp_name=${exp_name} --overwrite \
  ...
  --checkpoint_base_dir=/mnt/project_rlinf_hs/mjwei/download_models/behavior-1k/rft-comet/checkpoints_official_task00/ \
  --assets_base_dir=/mnt/project_rlinf_hs/mjwei/download_models/behavior-1k/rft-comet/checkpoints_official_task00/assets/ \
  --save_interval 5000 \
  --log_interval 10"
